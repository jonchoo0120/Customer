...
public class CustomerConfirmOrder extends JFrame {
    ...
    private String username, userID, contact, address, serviceType;

    public CustomerConfirmOrder(String username, String userID, String contact, String address, Map<String, Integer> itemQuantityMap, Map<String, Double> itemPriceMap, String serviceType) {
        ...
        modifyOrderButton.addActionListener((ActionEvent e) -> {
            ...
            SwingUtilities.invokeLater(() -> new CustomerPlaceOrder(username, userID, contact, itemQuantityMap, itemPriceMap));
        });
        ...
        makePaymentButton.addActionListener((ActionEvent e) -> {
            ...
            paymentSuccessGUI.showOrderSuccessMessage(username, userID, contact, orderId);
            dispose();
        });
