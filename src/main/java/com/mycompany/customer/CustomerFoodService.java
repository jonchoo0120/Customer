...
public class CustomerFoodService extends JFrame {
    ...
    public CustomerFoodService(String username, String userID, String contact, Map<String, Integer> itemQuantityMap, Map<String, Double> itemPriceMap) {
    ...
    private void openCustomerConfirmOrder(String serviceType) {
        ...
        CustomerConfirmOrder confirmOrder = new CustomerConfirmOrder(username, userID, contact, address, itemQuantityMap, itemPriceMap, serviceType);
